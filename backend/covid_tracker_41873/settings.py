"""
Django settings for covid_tracker_41873 project.
...
ROOT_URLCONF = 'covid_tracker_41873.urls'
...
WSGI_APPLICATION = 'covid_tracker_41873.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "covid_tracker_41873 API",
    "DESCRIPTION": "API documentation for covid_tracker_41873 App",
    "VERSION": "v1",
}
